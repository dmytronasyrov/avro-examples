...
public class KafkaAvroConsumerV2 {
  ...
  public static void main(String[] args) {
    ...
    final KafkaConsumer<String, CustomerV2> consumer = new KafkaConsumer<>(properties);
    consumer.subscribe(Collections.singleton("customer-avro"));

    System.out.println("Waiting for data...");

    while (true) {
      final ConsumerRecords<String, CustomerV2> records = consumer.poll(Duration.ofMillis(500));
